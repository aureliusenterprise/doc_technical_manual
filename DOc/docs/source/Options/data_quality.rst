...
============================  =======================================================
   ...
   +------------------------+--------------------------------------------------------+
   | Compare first          | Checks whether the first 'number_of_characters' values|
   | characters starting    | in `first_column_name` and `second_column_name` are     |
   | without                | similar, and if `column_name` does not start with any   |
   |                        | of the given `prefixes`, and if the values are None or  |
   |                        | NaN.                                                   |
   +------------------------+--------------------------------------------------------+
   | Completeness           | Checks whether the values in the column with the given |
   |                        | `column_name` are None or NaN.                         |
   ...
   |                        |`value_column` are `None` or `NaN`.                      |
   +------------------------+--------------------------------------------------------+
   | Conditional unallowed  |Checks if values in the column with the given           |
   | text                   |`value_column` contain a specific unallowed `text`.     |
   +------------------------+--------------------------------------------------------+
   | Conditional value      |Checks whether the values in the given `value_column`   |
   |                        |match (one of) the expected value(s) for a given key     |
   |                        |in the `key_column`.                                    |
