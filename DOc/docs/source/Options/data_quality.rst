...
|                  |                                                                 |
| Compare first    |                                                                 |
|   characters     |           Checks whether the first 'number_of_characters' values|
...
|                  |                                                                 |
| Conditional      |                                                                 |
|   completeness   |             Checks whether or not the values in the given       |
...
|                  |                                                                 |
|   Cross-Column   |                                                                 |
|      Validity    |         Checks whether or not the combination of values in the  |
